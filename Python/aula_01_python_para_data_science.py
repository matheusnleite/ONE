...
Original file is located at
    https://colab.research.google.com/drive/1C3ZvojufEJZSPRwZX73eLwFesezcLoTN
...
for i in range(len(estudantes)):
  codigo_estudantes.append((estudantes[i], estudantes[i][0] + gera_codigo())) #estudantes[i][0] = pegando o primeiro elemento da string
