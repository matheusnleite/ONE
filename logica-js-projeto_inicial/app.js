...
let numeroSecreto = parseInt(Math.random() * numeroMaximo + 1); // gerar numero aleatorio
...
while(chute != numeroSecreto){
  chute = prompt(`Escolha um número entre 1 e ${numeroMaximo}`); //exibi uma caixa de diálogo que solicita uma entrada do usuário
